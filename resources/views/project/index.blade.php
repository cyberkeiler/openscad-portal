...
<div class="row">
	...
	<div class="col-sm-4">
		...
		@section ('part'.$part->id.'_panel_body')
			{{ $part->description}}
		@endsection
		@section ('part'.$part->id.'_panel_footer', '  <a class="btn btn-primary" href="/view?part='.$part->id.'" role="button"><i class="fa fa-eye"></i> View</a> <a class="btn btn-primary" href="/project/'.$part->id.'" role="button"><i class="fa fa-pencil"></i> Edit</a> <a class="btn btn-danger" href="/project/'.$part->id.'" role="button"><i class="fa fa-trash"></i> Delete</a>')
