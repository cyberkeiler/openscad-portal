...
<div class="row">
	...
	<div class="col-sm-4">
		@section ('part'.$part->id.'_panel_title', '<a href="/project/'.$part->id.'">'.$part->title.'</a> <a class="btn btn-default" href="/part/'.$part->id.'/edit" role="button"><i class="fa fa-pencil"></i></a>')
		@section ('part'.$part->id.'_panel_body')
			{{ $part->description}}
		@endsection
		@section ('part'.$part->id.'_panel_footer', '  <a class="btn btn-primary" href="/view?part='.$part->id.'" role="button"><i class="fa fa-eye"></i> '.trans('project.Viewer').'</a> <a class="btn btn-primary" href="/editor?part='.$part->id.'" role="button"><i class="fa fa-indent"></i> '.trans('project.Editor').'</a>  <a class="btn btn-primary" href="/part/'.$part->id.'/edit" role="button"><i class="fa fa-pencil"></i></a> <a class="btn btn-danger" href="/project/'.$part->id.'" role="button"><i class="fa fa-trash"></i></a>')
		@include('widgets.panel', array('class'=>'default', 'header'=>true, 'footer'=>true, 'as'=>'part'.$part->id))
	</div>
	@endforeach
	<div class="col-sm-4">
		<a class="btn btn-success btn-lg" href="/project/{{ $project->id }}/newpart" role="button"><i class="fa fa-plus"></i> {{ trans('project.CreatePart') }} &nbsp; </a>
	</div>
</div>
@endsection
